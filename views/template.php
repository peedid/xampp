      ...
      <ul class="list" data-role="listview" data-filter="true" data-inset="true" data-input="#rich-autocomplete-input" id="listGCustomer" >
           <?php 
              ...
              ?>  
                 ...
                 <li class="li_list" style="margin-bottom: 5px; background-color: #2c3e50; padding-bottom: 20px; "  ><!-- taruh alias didalam li, contoh: id = "<?= $row->KODE_GUDANG; ?>" -->
                          <!--    <a href="#" data-yussi = "<?= $row->KODE_GUDANG; ?>"> -->
