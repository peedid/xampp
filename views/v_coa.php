    ...
    <div>
      ...
      <div>
        ...
        <?php 
          ...
          ?>
        <div data-role="collapsible" data-mini="true" data-filter="true" data-inset="true" data-input="#rich-autocomplete-input" id="listcoa" >
          
            <h3><?= $row->PARENT_COA; ?></h3>
            <p><?= $row->KODE_COA; ?></p>
              ...
              <div style="float: right; width: 60%">
                ...
                <tr>
                  <td style="width: 100%">
                    ...
                    <div style="width: 33%;" >
                        <input type="button" name="detil_klik" id="detil_klik" value="detil" data-inline="true" data-theme="b" data-mini="true"
                        onclick="click_detil(
                     ...
                     <div style="width: 33%; margin-right: -5px; margin-left: -5px">
                        <input type="button" name="edit_klik" id="edit_klik" value="Edit" data-inline="true" data-theme="e" data-mini="true"
                        onclick="click_edit(
                        '<?= $row->STANDAR; ?>','<?= $row->GUDANG; ?>','<?= $row->KODE_GUDANG; ?>','<?= $row->ALAMAT; ?>','<?= $row->TELP; ?>','<?= $row->SURAT_DO; ?>','<?= $row->TAMPIL_RINCIAN_BARANG; ?>','<?= $row->HANYA_BARANG_MUTASI; ?>','<?= $row->HANYA_BARANG_GUDANG; ?>','<?= $row->SEMUA_BARANG; ?>','<?= $row->HEADER_NOTA; ?>','<?= $row->FOOTER_NOTA; ?>','<?= $row->FINGERPRINT_ADDRESS; ?>','<?= $row->FINGER_TYPE; ?>','<?= $row->SESUAI_GUDANG_JUAL; ?>','<?= $row->INNER_STOCK_BARANG_GUDANG; ?>','<?= $row->WAKTU_TOLERANSI; ?>')"   >
                      </div>
                      <div style="width: 33%">
                        <input type="button" name="hapus_klik" id="hapus_klik" value="Hapus" data-inline="true" data-theme="d" data-mini="true" onclick="click_hapus('<?= $row->KODE_GUDANG; ?>','<?= $row->GUDANG; ?>')" ></div>
                    </div>
