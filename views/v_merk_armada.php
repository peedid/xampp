...
<div data-role="page" id="page_utama" data-theme="a" data-transition="slide">
	<?php 
      ...
      <div data-role="content">
      	<div align="center" style="margin-top: -25px" ><h3><b>DAFTAR MEREK ARMADA</b></h3></div>
      	<div>
             ...
             <td>
              <table align="center">
                <tr>
                  ...
                  <td>
                    <div align="center" style=" background-color: orange; width:30px;border-radius: 50%;height:30px;" onclick="click_edit('<?= $row->MEREK;?>')">
                      <img   id="tambah_data" src="<?php echo asset_url();?>gambar/ubah.png" style="width:20px;height:20px; margin-top: 5px;">
                    </div>
                  </td>
                  <td>
                    <div align="center" style=" background-color: red; width:30px;border-radius: 50%;height:30px;" onclick="click_hapus('<?= $row->MEREK;?>')">
...
<div data-role="page" id="page_data" data-transision="slide">
  <?php 
      ...
      ?>
        ...
        <div align="center">
       <h3 id="tajuk"><b>TAMBAH DATA MERK ARMADA BARU</b></h3>
        </div>
        <div data-role='content'>  
        <div>
                              <?php echo form_open_multipart ("",array("method"=>"post","id"=>"form_gudang","name"=>"form_gudang","data-ajax"=>"false", "enctype"=>"multipart/form-data")) ?> 
                                ...
                                <input data-mini="true" type="text" name="merk_add" id="merk_add" value="">
...
<script type="text/javascript">
 ...
 function click_detil(kode) {
  $.mobile.changePage( "#page_data", { transition: "slide", changeHash: true });
      ...
      document.getElementById("merk_add").value = kode;
      document.getElementById("tajuk").innerHTML = 'DETAIL DATA MERK ARMADA';
 ...
 function click_edit(kode) {
  $.mobile.changePage( "#page_data", { transition: "slide", changeHash: true });
      ...
      document.getElementById("tajuk").innerHTML = 'UBAH DATA MERK ARMADA';
...
function click_hapus(id){ 
        ...
        document.getElementById('isi_hapus').innerHTML = 'Data Merk Armada ' + id + ' akan di hapus ?';
...
$('#form_delete').submit(function(event){
      ...
      if ($('#id').val()=="") {
        ...
        showModal();
        $.ajax({
                url:'<?php echo home_url()?>MasterData/delete_merk_armada',
                method: 'POST',
...
function add_data(){
$.mobile.changePage( "#page_data", { transition: "slide", changeHash: true });
      document.getElementById("merk_add").value = null;
      document.getElementById("key").value = null;
      document.getElementById("tajuk").innerHTML = 'TAMBAH DATA ARMADA';
...
$('#form_gudang').submit(function(event){
      ...
      if ($('#id').val()=="") {
        ...
        if (status == "tambah") {
              alamat = '<?php echo home_url()?>MasterData/save_merk_armada'
        }
        else
        {
          alamat = '<?php echo home_url()?>MasterData/edit_merk_armada'
        }
