...
function add_data(){
  $.mobile.changePage( "#page_data", { transition: "slide", changeHash: true});
    ...
    $("#operator_add").prop('selectedIndex', 0);
    $("#penyesuaian_add").prop('selectedIndex', 0);
    $("#validasi_add").prop('selectedIndex', 0);
    $("#gudang_add").selectmenu("refresh");
    $("#operator_add").selectmenu("refresh");
    $("#penyesuaian_add").selectmenu("refresh");
    $("#validasi_add").selectmenu("refresh");
    document.getElementById("key").value=null;
    document.getElementById("key_op").value= null;
    document.getElementById("tajuk").innerHTML = 'TAMBAH AKSES OPERATOR';
