...
<script type="text/javascript">
 ...
 function click_edit(satuan,kode,tingkatan,penanda) {
  $.mobile.changePage( "#page_data", { transition: "slide", changeHash: true });
      ...
      document.getElementById("kode_satuan_add").disabled=false;
      document.getElementById("btn_edit").style.display = 'inline';

      document.getElementById("satuan_add").disabled = false;
      document.getElementById("tingkatan_add").disabled = false;
      document.getElementById("penanda_add").disabled = false;
      status = 'edit';
...
$.mobile.changePage( "#page_data", { transition: "slide", changeHash: true});
    ...
    document.getElementById("tajuk").innerHTML = 'TAMBAH DATA SATUAN';
     document.getElementById("satuan_add").value = null;
      document.getElementById("kode_satuan_add").value = null;
       $('#tingkatan_add').prop('selectedIndex', 0);
      $("#tingkatan_add").selectmenu("refresh")
      document.getElementById("penanda_add").value = null;
      document.getElementById("kode_satuan_add").disabled=false;
      document.getElementById("btn_edit").style.display = 'inline';
