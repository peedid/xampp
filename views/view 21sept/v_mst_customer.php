...
<body>
  <div data-role="page" id="page_utama" data-theme="a" data-transition="slide">
    <?php 
      ...
      ?>
  <div style="margin-top: -10px"><h3 align="center"><b>DAFTAR CUSTOMER</b></h3></div>
  <?php
          ...
          <li class="li_list" style="margin-bottom: 5px; background-color: #2c3e50; padding-bottom: 10px; " >
             <div style="background-color: #2c3e50; clear: both;">
              ...
              <div style="float: right; width: 60%">
                ...
                <div align="center">
                  <input align="center" type="button" name="detil_klik" id="detil_klik" value="detil" data-inline="true" data-theme="b" data-mini="true" onclick="click_detil('<?= $row->NAMA_CUSTOMER; ?>','<?= $row->ALAMAT; ?>','<?= $row->NAMA_ORANGTUA; ?>','<?= $row->GROUP_CUSTOMER; ?>','<?= $row->TELP; ?>','<?= $row->PLAFOND_KREDIT; ?>','<?= $row->HARGA_JUAL; ?>','<?= $row->KODE_CUSTOMER; ?>')"   >
                <input align="center" type="button" name="edit_klik" id="edit_klik" value="Edit" data-inline="true" data-theme="e" data-mini="true" onclick="click_edit('<?= $row->NAMA_CUSTOMER; ?>','<?= $row->ALAMAT; ?>','<?= $row->NAMA_ORANGTUA; ?>','<?= $row->GROUP_CUSTOMER; ?>','<?= $row->TELP; ?>','<?= $row->PLAFOND_KREDIT; ?>','<?= $row->HARGA_JUAL; ?>','<?= $row->KODE_CUSTOMER; ?>')"   >
    ...
    <div data-role="popup" id="tanya_hapus" data-theme="a" data-transition="slide" align="center">
      ...
      <div role="main" class="ui-content">
            ...
            <div align="center">
              ...
              <a href="#" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" onclick="GoBack()">Cancel</a>
            </div>
      </div>
    </div>
       ...
       <h3 id="tajuk"><b>TAMBAH DATA CUSTOMER BARU</b></h3>
        ...
        <div>
                              ...
                              <input data-mini="true" type="text" name="kode_add" id="kode_add" value="">
                               ...
                               <input data-mini="true" type="text" name="penjamin_add" id="penjamin_add" value="">
                               ...
                               <input data-mini="true" type="number" name="kredit_add" id="kredit_add" value="">
...
var status =""
 ...
 function click_detil(nama,alamat,penjamin,group,hp,kredit,kolom_harga,kode,kode_gudang) {
  $.mobile.changePage( "#page_data", { transition: "slide", changeHash: true });
    ...
    $('#kode_gudang_add').val($('#gudang_option').val());
